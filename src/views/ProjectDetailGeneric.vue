      ...
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div class="animate-fade-in">
            <span class="badge mb-4" :class="project.categoryClass">{{ project.category }}</span>
        ...
        <div class="card bg-base-200 animate-scale-in">
          <div class="card-body">
            ...
            <div class="card-actions justify-end">
              ...
              <router-link to="/#contact" class="btn" :class="getButtonClass()">
                Get In Touch
              </router-link>
            </div>
          </div>
...
const handleImageError = (event) => {
  // Hide the image and show the fallback gradient
...
const getCallToActionText = () => {
  ...
  const categoryTexts = {
    ...
    'Startup': 'This startup experience demonstrates scalable backend development and AI integration.'
  }
