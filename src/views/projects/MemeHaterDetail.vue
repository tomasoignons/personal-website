    ...
    <section class="py-20 bg-base-100">
      <div class="max-w-4xl mx-auto px-6">
        ...
        <div class="card bg-base-200 animate-scale-in">
          <div class="card-body">
            <h3 class="card-title text-base-content">Exploring AI Research?</h3>
            ...
            <div class="card-actions justify-end">
              ...
              <router-link to="/#contact" class="btn text-white border-none" :style="{ background: project.gradient }">Discuss Research</router-link>
            </div>
          </div>
        </div>
      </div>
...
const { project, getBadgeClass, getButtonClass, getCallToActionText, getTechBadgeClass, formatFeature } = useProject('memehater')
